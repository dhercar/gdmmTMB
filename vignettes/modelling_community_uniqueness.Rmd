...
```{r, message=FALSE, warning=FALSE,  dev="svg", out.width="100%"}
...
```{r, dev="svg", out.width="100%", results = 'hide'}
# fit model
m_gdmm <-
  gdmm(Y = Y,
       X = Xenv,
...
```{r, echo = F, message = F, dev="svg", out.width="100%"}
# generate predictions
...
```{r, echo = F, message = F, warning = F, error = F, dev="svg", out.width="100%", results = 'hide'}
...
```{r, echo = F, dev="svg", out.width="100%"}
cowplot::plot_grid(
